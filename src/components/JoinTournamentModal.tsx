        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-200 mb-4 bg-yellow-900/50 p-3 rounded-lg font-sans">Pay <strong className="text-white">৳{tournament.prize_pool} BDT</strong> to our bKash number: <strong className="text-white">01301440744</strong> (Send Money), then fill the form below.</p>
