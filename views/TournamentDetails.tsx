    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-8">
                ...
                {showRoomDetails && (tournament.roomId || tournament.roomPassword) ? (
                    <div className="space-y-6 text-center">
                        <div>
                            <p className="text-lg text-gray-400">Room ID</p>
                            <p className="text-3xl font-mono bg-gray-900 inline-block px-8 py-3 rounded-lg text-white tracking-widest cursor-pointer" title="Click to copy">{tournament.roomId || 'Not set'}</p>
                        </div>
                        <div>
                            <p className="text-lg text-gray-400">Room Password</p>
                            <p className="text-3xl font-mono bg-gray-900 inline-block px-8 py-3 rounded-lg text-white tracking-widest cursor-pointer" title="Click to copy">{tournament.roomPassword || 'Not set'}</p>
                        </div>
